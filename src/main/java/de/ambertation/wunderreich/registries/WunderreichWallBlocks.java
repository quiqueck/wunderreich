...
public class WunderreichWallBlocks {
    ...
    public static final Block BIRCH_WALL = registerWoodWall(
            "birch_wall",
            Blocks.BIRCH_PLANKS,
            Blocks.BIRCH_FENCE,
            Configs.MAIN.addWalls.get()
    );
    public static final Block OAK_WALL = registerWoodWall(
            "oak_wall",
            Blocks.OAK_PLANKS,
            Blocks.OAK_FENCE,
            Configs.MAIN.addWalls.get()
    );
    public static final Block DARK_OAK_WALL = registerWoodWall(
            "dark_oak_wall",
            Blocks.DARK_OAK_PLANKS,
            Blocks.DARK_OAK_FENCE,
            Configs.MAIN.addWalls.get()
    );
    public static final Block JUNGLE_WALL = registerWoodWall(
            "jungle_wall",
            Blocks.JUNGLE_PLANKS,
            Blocks.JUNGLE_FENCE,
            Configs.MAIN.addWalls.get()
    );
    public static final Block CRIMSON_WALL = registerWoodWall(
            "crimson_wall",
            Blocks.CRIMSON_PLANKS,
            Blocks.CRIMSON_FENCE,
            Configs.MAIN.addWalls.get()
    );
    public static final Block WARPED_WALL = registerWoodWall(
            "warped_wall",
            Blocks.WARPED_PLANKS,
            Blocks.WARPED_FENCE,
            Configs.MAIN.addWalls.get()
    );
    public static final Block SPRUCE_WALL = registerWoodWall(
            "spruce_wall",
            Blocks.SPRUCE_PLANKS,
            Blocks.SPRUCE_FENCE,
            Configs.MAIN.addWalls.get()
    );
    public static final Block MANGROVE_WALL = registerWoodWall(
            "mangrove_wall",
    ...
    public static Block registerWoodWall(
            String name,
            Block baseBlock,
            Block fenceBlock,
            boolean register
