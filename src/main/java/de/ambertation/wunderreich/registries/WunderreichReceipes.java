...
public class WunderreichReceipes {
    public static void register() {
        ...
        GridRecipe.make(Wunderreich.makeID("whisper_imprinter"), WunderreichBlocks.WHISPER_IMPRINTER)
                .checkConfig(WunderreichConfigs.RECIPE_CONFIG)
                .setShape(
                    "ABA",
                    "DCD",
        ...
        GridRecipe.make(Wunderreich.makeID("builders_trowel"), WunderreichItems.BUILDERS_TROWEL)
                  .checkConfig(WunderreichConfigs.RECIPE_CONFIG)
                  .setShape(
                      "***",
                      " * ",
